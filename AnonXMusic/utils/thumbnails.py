...
async def get_thumb(videoid, user_id):
    ...
    try:
        ...
        draw_rounded_rect(draw, panel_box, 60, outline=(0, 255, 255, 120), width=6)
        ...
        draw_rounded_rect(draw, (bar_x1, bar_y, bar_x2, bar_y + 14), 7, fill=(255, 255, 255, 40))
        draw_rounded_rect(draw, (bar_x1, bar_y, bar_x1 + 450, bar_y + 14), 7, fill=(0, 255, 255, 180))
